<?php include('server_we.php') ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>MS Hotel Registration</title>
    ...
    <div class="d-flex justify-content-center h-100">
        <div class="user_card">
            ...
            <div class="d-flex justify-content-center form_container">
                ...
                <?php include('errors_sign_up.php') ?>
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="password" name="password_1" class="form-control input_pass" value="" placeholder="password" required>
                    </div>
                    <div class="input-group mb-2">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                        </div>
                        <input type="password" name="password_2" class="form-control input_pass" value="" placeholder="confirm password" required>
                    </div>
                   
                        <div class="d-flex justify-content-center mt-3 login_container">
                 <button type="submit" name="reg_user" class="btn login_btn">SIGN UP</button>
               </div>
                </form>
            </div>
            ...
            <div class="mt-3">
                <div class="d-flex justify-content-center links">
                    Already have an account? <a href="sign_in.php" class="ml-2">LOG IN</a>
                </div>
